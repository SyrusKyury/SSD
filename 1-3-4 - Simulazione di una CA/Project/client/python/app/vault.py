...
def initialize_credentials(username : str, token : str, file_path : str) -> tuple[str, str, str, str, str, str, str]:
    try:
    ...
    return data['url'], data['token'], data['storage_key'], data['data_path'], data['transit_path'], data['kv_v2_path'], data['client_id']